...
({
    ...
    validateForm : function(cmp, event, helper){
        console.log('NewAddressModal validateForm...');
    ...
    getAddressDetails : function(cmp, manual, ka, addressId){
        console.log('NewAddressModal getAddressDetails...');
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") {
                    ...
                    if(resp.candidates.length>0) {
                        ...
                        cmp.set("v.manual", true);
                        this.getAddressDetails(cmp, true, ka, addressId);
                    }
    ...
    getNewStatesList : function(cmp, countryVal){
        console.log('NewAddressModal getNewStatesList...');
        return new Promise(
