...
({
    addressIdChange: function (cmp, event, helper) {
        console.log('NewAddressForm addressIdChange...');
    ...
    toggleManualEntry: function (cmp, event, helper) {
        console.log('NewAddressForm toggleManualEntry...');
    ...
    checkType: function (cmp, event, helper) {
        console.log('NewAddressForm checkType...');
    ...
    handleSubmit: function (cmp, event, helper) {
        console.log('NewAddressForm handleSubmit...');
        ...
        if (helper.validateForm(cmp)) {
            ...
            // cmp.find('manualEntry').set("v.value", cmp.get("v.manual"));
            cmp.find('newAddressForm').submit();
        } else {
    ...
    handleSuccess: function (cmp, event, helper) {
        console.log('NewAddressForm handleSuccess...');
    ...
    handleError: function (cmp, event, helper) {
        console.log('NewAddressForm handleError...');

        console.log('ERROR SAVING RECORD.');
    },

    onCountryChange: function (cmp, event, helper) {
        console.log('NewAddressForm onCountryChange...');
